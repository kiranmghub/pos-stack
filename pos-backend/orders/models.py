...
#     register = models.ForeignKey("stores.Register", on_delete=models.PROTECT)
...
#     status = models.CharField(max_length=24, default="completed") # open/completed/voided
#
#     def __str__(self):
...
#
#     def __str__(self):
#         return f"{self.variant} x {self.qty} (sale #{self.sale_id})"
